...
class conn {
	...
	function conn() { //Construtor
		//naxos.uni5.net
		$c = mysql_connect('200.157.178.99', 'webmkt', '103010');// || die ("Não foi possível conectar ao mysql");
		mysql_select_db('webmkt', $c);// || die ("Não foi possível selectionar o database mysql");
		$this->conn = $c;
	}
