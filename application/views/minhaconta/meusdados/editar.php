			...
			<div class="col-lg-6 border-left-custom">
				...
				<div class="col-lg-11 no-padding margin-bottom-17">
					<div class='col-lg-6 no-padding'>
						...
						<input autocapitalize="off" autocomplete="off" required autocorrect="off" class="form-control" id="id_telefone_celular" name="telefone" spellcheck="false" type="tel" maxlength="11" value="{telefone}">
					</div>
