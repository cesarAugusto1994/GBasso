<div class="modal fade" id="cadastrarItemMenu">
    <div class="modal-dialog">
        <div class="modal-content" style='width: 850px;'>
            ...
            <form class='cadastrar-menu' method='POST' action='{url}admin/ajax/menus/cadastrarItemMenu'>
                <div class="modal-body panel-default">
                    <fieldset>
                        <div class="col-lg-4">
                            <label>Menu</label>
                            <select class='form-control selectpicker' name='submenu'>
                                {subMenus}
                        ...
                        <input type='hidden' name='idItemMenu' id='idItemMenu' />
                    </fieldset>
                </div>
