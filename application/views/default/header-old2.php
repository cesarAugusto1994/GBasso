            ...
            <nav class="topBar">
                <div class="container">
                    ...
                    <ul class="topBarNav pull-right">
                        <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="false"> <i class="glyphicon glyphicon-user"></i>   <span class="">Minha Conta<i class="glyphicon glyphicon-down ml-5"></i></span> </a>
