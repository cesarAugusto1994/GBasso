    ...
    <footer class="footer" style='background-color: #000000; padding-top: 20px;'>
        <div class="row">
            <div class="col-md-4" style="border-right: 1px solid #FFFFFF">
            ...
            <div class="col-md-4" style=" color: #ffffff; border-right: 1px solid #FFFFFF">
    ...
    <script>
        $('#logar-dropdown').mouseover(function() {
            $('#user').focus();
        });
    </script>
