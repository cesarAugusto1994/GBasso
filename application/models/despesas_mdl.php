...
class Despesas_mdl extends CI_Model {
    ...
    * 
    */      
    public function getJoinTables($fieldReturn, $compare, $tableJoin, $valueJoinCond, $tableJoin1, $valueJoinCond1, $tableJoin2, $valueJoinCond2, $tableJoin3, $valueJoinCond3, $table){
