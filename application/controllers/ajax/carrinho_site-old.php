...
class Carrinho_site extends CI_Controller {
    ...
    */
    ...
    public function getValorFrete() {
        ...
        strlen( $cep ) != 8  ?  $this->Essentials->setMessage( 'Cep inválido, selecione um endereço válido' ) : null;
    ...
    protected function generateFrete( $cep, $servico ) {
        ...
        !$response  ?  $this->Essentials->setMessage( 'Cep inválido, selecione um endereço válido' ) : null;
