...
class Banners extends CI_Controller {
    ...
    public function cadastrar() {
        ...
        //Get file js
        $data['footer']['js']    =   $this->Header->getJs( array( 2, 3, 6, 8, 14, 20 ) );
        ...
        $this->parser->parse('admin/banners/cadastrar_banners', $data['body'] );
    ...
    public function visualizar() {
        ...
        //Get file js
        $data['footer']['js']    =   $this->Header->getJs( array( 2, 6, 8, 14, 20 ) );
        ...
        //Get local Banners
        $data['body']['banner']  =   $this->Banners->getBannersLocais();
        ...
        $this->parser->parse('admin/banners/visualizar_banners', $data['body'] );

        $this->parser->parse('admin/default/footer', $data['footer'] );

    }

    public function visualizar_imagens( $idLocal = '' ) {
        ...
        if( !is_numeric( $idLocal ) ) {
            ...
            //Data banners
            $data['body']['imagens'] =   $this->Banners->getImagens();

            //Local
            $data['body']['local']   =   $idLocal;
            ...
            $this->parser->parse('admin/banners/visualizar_imagens', $data['body'] );
